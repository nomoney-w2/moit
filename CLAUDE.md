...
- TypeScript 5 + React 19, Next.js 16 (App Router), Tailwind CSS 4 + CVA + clsx + tailwind-merge, date-fns, ky(미사용 — 본 단계 mock), zod(미사용 — 본 단계 mock) (feat/#68-vote-rank-cards)
- N/A (클라이언트 mock fixture) (feat/#68-vote-rank-cards)
